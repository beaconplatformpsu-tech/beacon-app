...
export const practiceTasks: Record<string, SeedPracticeTask> = {
  ...
  task_ts_interface_modeling: {
    ...
    instructions:
      "Create TypeScript interfaces for Student, Course, Skill, Resource, and Task. Add enums for task status and priority. Write sample objects and make sure TypeScript catches invalid values.",
